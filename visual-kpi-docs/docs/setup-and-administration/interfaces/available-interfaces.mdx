...
In addition to listing all the available interfaces, we've included step-by-step instructions for installing them in **Visual KPI Server Manager**. These instructions are easy to follow and will help you get up and running with your chosen interfaces in no time.
...
1. Right-click the ODBC interface and select **Browse**. Your browser will open and display the Interface’s Web Service page.
2. Click any of the Test links.
3. In the _LookupValue_ field, enter a valid lookup name and click the **Invoke** button. A new instance of your browser will open.
