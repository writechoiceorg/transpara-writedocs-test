...
:::training
Refer to **[Visual KPI training](https://www.transpara.com/lesson/creating-odbc-interfaces-sql-2/)** to learn all about how Visual KPI interfaces with and reads from thousands of data sources and how to create your own interfaces.
:::
