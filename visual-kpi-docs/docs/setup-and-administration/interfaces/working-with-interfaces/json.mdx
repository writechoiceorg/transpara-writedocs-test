...
<Tabs>
  ...
  <TabItem value="Parameterized" label="Parameterized" default>
    ...
    Where, in Visual KPI Designer, you would use `data.|CPU|timestamp` as the lookup.
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem value="Parameterized" label="Parameterized">
    ...
    Where, in Visual KPI Designer, you would use `data.|CPU|timestamp` as the lookup, `2024-02-17T12:30:00` as **STARTDATE**, and `2024-06-15T12:30:00` as **ENDDATE**.
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem value="Parameterized" label="Parameterized">
    ...
    Where, in Visual KPI Designer, you would use `data.|CPU|timestamp` as the lookup, and `2024-06-15T12:30:00` as **TIMESTAMP**.
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem value="Parameterized" label="Parameterized">
    ...
    Where, in Visual KPI Designer, you would use `data.|CPU|timestamp` as the lookup, and `2024-02-17T00:30:00` as **TIMESTAMP**.
  </TabItem>
</Tabs>
