...
4. [Verify the connection](#verifying-an-interface-connection).
5. [Test the connection](#testing-an-interface-connection).
...
<StylizedImage
  imgURL="img/setup-adm/interfaces/test/test-1.png"
  alt=""
  wSize="80%"
/>
...
<StylizedImage
  imgURL="img/setup-adm/interfaces/test/test-2.png"
  alt=""
  wSize="80%"
/>
...
<StylizedImage
  imgURL="img/setup-adm/interfaces/test/test-3.png"
  alt=""
  wSize="80%"
/>
