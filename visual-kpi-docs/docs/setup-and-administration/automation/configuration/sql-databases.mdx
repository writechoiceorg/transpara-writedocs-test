...
The Visual KPI Remote Context Server can connect to any SQL data source. All required is ODBC access with appropriate read-level permissions. This page is a guide on what you need to know and do to use RCS with your SQL database.
