...
RCS will automatically detect any new KPIs or objects added to your master application. You can choose the frequency of RCS to read those changes periodically, and the new objects will appear in Visual KPI without any manual intervention. The same is true for any changes or deletions you make to objects. Visual KPI automates everything every time RCS runs.
...
Visual KPI RCS has the ability to extract various types of data from different external applications, as listed below:
