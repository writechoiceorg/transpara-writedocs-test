...
4. **Preview updates** (<PngFont name='preview28-2.fw' />): Shows a preview of the calculations of the selected objects. This can take a long time if you mark many items on the worksheet.
