...
Another feature we presented in the [UI Tour](/docs/visual-kpi-designer/interface-tour-and-core-patterns/ui-tour) is the button to toggle Basic and Advanced modes of the worksheets (<PngFont name='advancedmode28gray' />). You can use this button to make your use of Visual KPI Designer easier.
