...
- **[Profiles](/docs/visual-kpi-design/authoring/profiles-dashboards#profiles)**: Collections of dashboards, Watchlists, and bookmark bars, which are associated with individuals, roles, sites, assets, etc.
