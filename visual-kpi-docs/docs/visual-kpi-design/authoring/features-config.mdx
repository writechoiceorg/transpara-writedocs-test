...
When custom chart colors are added, they become the new default colors sitewide, overriding the original Visual KPI defaults. These custom colors will appear in the drop-down menu for all charts with a color or pen option. The chart colors will update with your new custom colors for existing charts that use default colors.
