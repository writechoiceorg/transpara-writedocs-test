...
Using Visual KPI Designer, you can configure KPI Status, setting the icons and colors for each status as they should appear in your Visual KPI site. You set the basic, default parameters in sitewide settings and then these when you configure KPI status parameters for individual KPIs.
