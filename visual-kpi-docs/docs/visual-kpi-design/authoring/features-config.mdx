...
Use the site settings icon (add icon gear) to access **Features & Config** and **Website** to define basic configuration information for Visual KPI sites. You can edit many items, such as Site Basics, System Services, Tab, Collumn, and Text Defaults, amongst many others.
