...
Visual KPI Designer enables you to configure contacts that can be referenced in your KPI data. This feature gives end users quick access to the person responsible for a specific data set. Once you've created and saved a contact, it becomes available in the Contact drop-down lists within the Groups, KPIs, Charts, and Tables worksheets in Visual KPI Designer.
