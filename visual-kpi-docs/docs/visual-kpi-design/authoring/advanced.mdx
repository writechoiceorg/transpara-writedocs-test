...
Use caution when naming your attributes. Do NOT use the same name for multiple attributes.
...
However, in some cases, you'll see variables [X] in Visual KPI strings. You don't want to translate the variable because it is a placeholder for text that is returned.
