...
Of course, Visual KPI Designer allows you to control many configurations. However, this page will help you create the basic configurations and explain the available features.
...
1. In the **Cache Alert Notification Protocol** field, use the drop-down menu to select a notification method. When set to None, notifications will not be sent.
2. In the **Cache Alert Reminder Interval** (minutes) field, enter a value indicating the frequency of sending cache alert reminders. When the value is 0, the Reminders will not be sent.
