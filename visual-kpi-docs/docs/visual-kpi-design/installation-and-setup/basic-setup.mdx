...
1. In the **Cache Alert Notification Protocol** field, use the pull-down menu to select a notification method. When set to None, notifications will not be sent.
