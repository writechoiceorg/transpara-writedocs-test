...
KPIs with an assigned Display Order are listed at the top of the page in Display Order. KPIs without an assigned Display Order are displayed in alphabetical order, following the KPIs with an assigned Display Order.
