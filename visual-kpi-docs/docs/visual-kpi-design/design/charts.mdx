...
To save a Chart, place an **x** in the first column and click the Save icon ( add icon ) in the open Chart tab of the Objects Toolbar. It is important to note that ALL Charts with an **x** in the (x) column will be saved. You can remove the **x** for any Chart you do not want to save or update.
