...
Use the Visual KPI Designer or Remote Context Server to configure Group Maps. Here are some of the settings you can (and, in some cases, must) configure (using the Designer as the example):
...
:::
{/* This image doesn't make sense. Try to find a new one
<StylizedImage
