...
In a Group Map, the group status — based on the status of the most recently changed KPI in the group or the worst performing KPI in the group — is determined by your settings in Visual KPI Designer. The top bar, the Group Map header, displays group status (color and icon, depending on settings).
