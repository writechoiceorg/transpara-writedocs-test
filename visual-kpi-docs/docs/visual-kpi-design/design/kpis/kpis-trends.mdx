...
From the Trend Scale pull-down list, select the type of trend to be used for the KPI. You can select either Single Scale or Multi-Scale. In Single Scale mode, only the Target line indicator will be displayed. In Multi-Scale mode, all status indicator lines will appear in the trend.
