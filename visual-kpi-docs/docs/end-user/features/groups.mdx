...
The Chart List View shows you the chart name, the type of chart, a mini visualization of the chart, and a description of the chart. You can use the Filters (<SvgFont icon="184"/>) and the Headers (<SvgFont icon="252"/>) to filter and sort your data. Learn more about [Filters](./basic-navigation/visualization).
