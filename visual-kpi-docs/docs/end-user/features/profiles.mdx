...
3. **Watchlist**: The Watchlist gives you a set of customizable favorites list of KPIs. You can add as many to it as you want and the orange number beside the timestamp tells you how many KPIs on your Watchlist are in an alert condition. By default, you see them sorted by 'in alert' and 'not alert'. You can you multiple [KPI Visualizations](./visualization/kpi) with the top bar icons and sort the list by using the arrows beside the column title. 
