...
Profiles are where your Dashboards live and all the personalized layer of visual KPI is for an end user. A profile is a collection of important personalized things for a user, but it doesn't need to be a person. A profile can be related to a role, a site, a room, an asset, or anything else you might want.
