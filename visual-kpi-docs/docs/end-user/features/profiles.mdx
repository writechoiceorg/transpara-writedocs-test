...
<StylizedImage
  imgURL="img/docs/end-user/features/profiles/features-profilesoptions.png"
  alt="Customizable Items"
/>

## Bookmark bar

Click the bookmark bar icon to edit your favorite list. You can configure it in a few different ways:
...
[add gif features-bookmarkbar]

Here are some of the items you can pin to the Visual KPI bookmark bar:
...
You can also pin an element to the bookmark bar using the Options icon. Navigate to the dashboard, object, or other element you want to pin to the bookmark bar and use the Options icon to access the pull-down menu to select Pin to Bookmark Bar.
[add image features-optionsmenu]

## Working with profiles

Follow the steps below to create a Profile: 

1. Click the Profile icon under your company logo. 
