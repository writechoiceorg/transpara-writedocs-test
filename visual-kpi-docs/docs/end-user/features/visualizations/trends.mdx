...
If you are interested in deep diving into Trends, please check our [KPI Visualization](/docs/end-user/features/visualizations/kpi) page to learn about all the KPI visualization options that Visual KPI has to offer.