...
## What's next?
To continue learning the core concepts for End-Users, you can access the [KPIs](end-user/core-concepts/kpi) page to learn more about the KPIs you can monitor. 