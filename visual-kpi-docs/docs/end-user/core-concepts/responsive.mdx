...
id: responsive
title: Responsive
slug: end-user/core-concepts/responsive
...
Transpara's Visual KPIs is a responsive software designed and developed to adapt and function effectively across various devices, screen sizes, and resolutions. It aims to ensure that the user interface and user experience remain consistent and optimized, regardless of the device used to access the software.
...
## What's next?
To continue covering the core concepts for End-Users, you can access the  [Real Time](end-user/core-concepts/real-time) page to learn more about the near real-time data processing of Transpara's Visual KPI.  