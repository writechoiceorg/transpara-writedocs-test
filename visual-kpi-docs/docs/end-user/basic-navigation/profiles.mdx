...
1. Click in the **Profile** icon (<SvgFont icon="118"/>) under your company logo and select **Change Profile**. 
...
1. Click in the **Profile** icon (<SvgFont icon="118"/>) under your company logo and select **Change Profile** (<SvgFont icon="173"/>). 
