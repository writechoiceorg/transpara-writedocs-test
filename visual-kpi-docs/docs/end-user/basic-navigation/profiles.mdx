...
A profile contains configuration for personalized dashboards, bookmark bars, and watchlists. Therefore, changing a profile gives you a personalized view of the process you're monitoring. Below, you find the description for each of the available profile customizable items:

1. **Dashboards**: Click the Dashboard icon to see all dashboards created for the current profile. 
...
3. **Watchlist**: Click the Watchlist icon to see the KPIs' status added to closer monitoring. The Watchlist icon also indicates how many KPIs are in an alert condition. 
...
Profile groups can only be created and edited by the system administrator. When creating or editing a group, the administrator defines:

- User assigned to the group.
- Objects (KPI, Charts, Tables, Groups) available.

:::

You are not able to create a profile group. However, you can [create new profiles](profiles#how-to-create-a-profile). 
...
1. Click in the **Profile** icon under your company logo and select **Change Profile**. 
...
2. Select one profile from the dropdown menu.
...
Access the [Dashboards](dashboards) page to continue learning about Visual KPI basic navigation concepts.