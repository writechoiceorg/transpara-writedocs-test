...
slug: end-user/basic-navigation
...
1. **Group rollup**: In the **Groups** tab, you see the first group as All Groups, which summarizes all the KPIs from all groups in your Visual KPI. Click in one of the parent groups below to show the ones composing this parent. You can click in one of these child groups to see the KPIs that compose them. 
...
<StylizedImage
  imgURL="img/docs/end-user/basic-navigation/basic-navigation/visualization-topbar.png"
  alt="Top bar tools"
/>
...
Explore more details of the basic navigation accessing the [Profiles](end-user/basic-navigation/profiles) and learn more about the Profiles feature for Visual KPI.