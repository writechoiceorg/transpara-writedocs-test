...
Ad Hoc is a trend type you can create by combining different KPIs. You can use the Search feature to find related KPIs and then create Ad Hoc based on the results. This way, you have an easy approach to visualizing related content.
...
Check the available [Analytics](/docs/end-user/basic-navigation/analytics) Visual KPI provides.
