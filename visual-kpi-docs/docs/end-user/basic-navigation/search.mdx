...
The Visual KPI's Search feature allows you to search any object within your Visual KPI, including dashboards, KPIs, groups, charts, and tables. When you perform a search, Visual KPI will use different information depending on the object type to provide the search result: 
