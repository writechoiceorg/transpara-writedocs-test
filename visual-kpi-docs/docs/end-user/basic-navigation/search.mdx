...
The Visual KPI Search feature allows you to search any object within your Visual KPI, including dashboards, KPIs, groups, charts, and tables. When you perform a search, Visual KPI will use different information depending on the object type to provide the search result: 
...
Ad Hoc are a trend type you can create by combining different KPIs. You can use the Search feature to find related KPIs and then create Ad Hoc based on the results. This way, you have a easy approach to visualize related content.

To create an Ad Hoc, follow the steps below:

1. Search for the desired term using the **Search Bar**.
2. Click an object type to see all results that include the parameter you entered. For this example, we consider you choose the **KPIs** option.
...
In addition to the options listed on step 5, you also have the option to add the selected KPIs to Dashboard (<SvgFont icon="115"/>) or add them to Watchlist (<SvgFont icon="262"/>).
