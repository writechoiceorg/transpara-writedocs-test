...
Like all Visual KPI objects, Ad Hoc Trends updates in real-time. Each definition you create in the trend is called a “pen.” The Visual KPI Server retrieves or calculates the values associated with each pen definition based on the time range specified for the Ad Hoc Trend. The default trend view will depend on how your admin has configured trends. Still, you have so many options for viewing Visual KPI trends that you'll be able to see how a KPI is performing over time quickly. Here are some features of an Ad Hoc Trend:
