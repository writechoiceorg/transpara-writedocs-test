...
Visual KPIs alert notifications are a powerful feature that directs your attention within the software. These notifications, which can be sent to your email, for example, are customizable to suit your specific needs. On this page, you will find detailed instructions on how to configure these alerts, along with an overview of the different types of alerts available.

Every notification includes a link to Visual KPI (the green button). Specifically, this link takes you to a live KPI trend marked with the alert's exact moment, letting you see what led up to the event and what's happened since (regardless of when you clicked the link). Additionally, you can comment on a specific point or a period of the KPI trend to understand the issue notified by the alert.
