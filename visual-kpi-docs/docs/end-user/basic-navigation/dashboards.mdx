...
<StylizedImage
  ...
  alt="Menu options"
/>
:::info Add object to a dashboard

If you are in the Groups, KPIs, Charts, or Tables tabs, you can add any of the obejcts to a dashboard. See [Add new objects to your Dashboard](#add-new-objects-to-your-dashboard) to learn how to do so.
