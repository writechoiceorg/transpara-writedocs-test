...
1. Click on the dropdown **Dashboard** icon (<SvgFont icon="10"/>), on the top right corner.
2. Select **New Dashboard**.
3. Type a dashboard name and description.
4. If you want to copy an existing dashboard, check the **Copy Existing Dashboard** option. Use the pull-down menu to choose the existing dashboard you want to copy.
5. Click **Save**.
...
In the dashboard, the Options menu (<SvgFont icon="188"/>) offers different ways to interact with Visual KPI depending on what you are viewing, the configuration of your Dashboard, and whether it's locked or unlocked by the administrator. Here are the options available to you when on the Dashboard Tab:
...
7. **View in Server/Client Time** (<SvgFont icon="52"/>): Change between Server and Client Time, regardless of time zones. 
...
After customizing the dashboard, don't forget to click **Save** at the bottom of the Customize Dashboard panel or click on the green checkmark (<SvgFont icon="190"/>) at the top once you have customized your Dashboard. Otherwise, you'll lose your changes.
...
4. After setting all objects, click **Save** at the bottom of the screen or click on the green checkmark at the top (<SvgFont icon="190"/>).
...
You can add any object to your dashboard or even use an object, such as a KPI, to create a new dashboard with just that object. To add a new object to an existing or new dashboard, follow the steps:
