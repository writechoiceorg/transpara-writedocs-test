...
After customizing the dashboard, don't forget to click **Save** at the bottom of the Customize Dashboard panel or click on the green checkmark (<SvgFont icon="190"/>) at the top once you have customized your Dashboard.
...
1. Click in the **Options** menu (<SvgFont icon="180"/>).
