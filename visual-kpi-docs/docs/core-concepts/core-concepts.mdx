...
- **[Hierarchy/Groups](./core-concepts/hierarchy)**: In Visual KPI, hierarchy and groups act like organized folders. They contain KPIs, Charts, and Tables. Hierarchy is a way to categorize your data. It automatically shows data in different colors to indicate its status. You can easily see what percentage of KPIs are in different states. Groups summarize the status of everything inside them. 
