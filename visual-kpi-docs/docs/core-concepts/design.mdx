...
In Visual KPI, **Design and Authoring** involves configuring vital components within the system. These components encompass Groups, KPIs, Charts, and Tables. Designing these elements is fundamental to creating an effective and functional Visual KPI system. 


The Visual KPI Designer is an Excel-based tool that offers versatility for various tasks, from prototypes to large-scale systems. The KPI design process on Visual KPI is categorized into distinct sections, including Basics, User Experience, SPC, Extended, and Access Group List. Administrators wield the authority to manage links, ensuring streamlined user access to critical resources.
