...
<AccordionGroup>
  <Accordion title="How to obtain hash values for the Visual KPI installation?">
    If your organization's IT governance has strict requirements for ensuring that our installation media haven't been altered, you can contact our [Support](support@transpara.com). We will be happy to provide you with the relevant MD5 or SHA checksum to validate any Visual KPI build that you require.
