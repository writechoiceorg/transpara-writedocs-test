...
<SearchWrapper>
<AccordionGroup>
  <Accordion title="1. What is unique about Transpara's approach?">
  ...
  <Accordion title="6. Why can't I just build this type of system myself (DIY)?">
    ...
    - **Support and expertise**: Transpara is staffed by a team of experts who can provide support deployment assistance, configuration help, troubleshooting, and more — an especially valuable asset for organizations that do not have extensive in-house IT.
